...
public partial class MSSQLParser : Parser
{
    ...
    // delegators
        ...
        public MSSQLParser(ITokenStream input)
    		: this(input, new RecognizerSharedState()) {
        }

        public MSSQLParser(ITokenStream input, RecognizerSharedState state)
    		: base(input, state) {
    ...
    override public string[] TokenNames {
		get { return MSSQLParser.tokenNames; }
    }
    ...
    // $ANTLR start "id"
    // ..\\Plugin.mssql\\AntlrParser\\MSSQL.g:22:1: id : ( T_IDENT | T_QUOTED_IDENT );
    public MSSQLParser.id_return id() // throws RecognitionException [1]
    {   
        MSSQLParser.id_return retval = new MSSQLParser.id_return();
        retval.Start = input.LT(1);
        ...
        try 
    	{
            // ..\\Plugin.mssql\\AntlrParser\\MSSQL.g:22:3: ( T_IDENT | T_QUOTED_IDENT )
    ...
    {   
        ...
        try 
    	{
            // ..\\Plugin.mssql\\AntlrParser\\MSSQL.g:216:9: ( ADD | ALTER | AND | AS | ASC | BEGIN | BETWEEN | BY | CASCADE | CASE | CAST | CHECK | COLLATE | COLUMN | COMMIT | CONFLICT | CONSTRAINT | CREATE | CROSS | CURRENT_TIME | CURRENT_DATE | CURRENT_TIMESTAMP | UTC_TIMESTAMP | DATABASE | DEFAULT | DELETE | DESC | DISTINCT | DROP | ELSE | END | ESCAPE | EXCEPT | EXCLUSIVE | EXISTS | EXPLAIN | FOR | FOREIGN | FROM | GROUP | HAVING | IF | IN | INDEX | INNER | INSERT | INTERSECT | INTO | IS | JOIN | KEY | LEFT | LIKE | NOT | NULL | OF | ON | OR | ORDER | OUTER | PRIMARY | REFERENCES | ROLLBACK | SELECT | SET | TABLE | TEMPORARY | TEMP | THEN | TO | TRANSACTION | TRIGGER | UNION | UNIQUE | UPDATE | VALUES | VIEW | WHEN | WHERE | WITH | PARSER | XOR )
            // ..\\Plugin.mssql\\AntlrParser\\MSSQL.g:
            {
            	root_0 = (object)adaptor.GetNilNode();
    ...
    // $ANTLR start "sysname"
    // ..\\Plugin.mssql\\AntlrParser\\MSSQL.g:219:1: sysname : ;
    public MSSQLParser.sysname_return sysname() // throws RecognitionException [1]
    {   
        MSSQLParser.sysname_return retval = new MSSQLParser.sysname_return();
        retval.Start = input.LT(1);
        ...
        try 
    	{
            // ..\\Plugin.mssql\\AntlrParser\\MSSQL.g:219:9: ()
            // ..\\Plugin.mssql\\AntlrParser\\MSSQL.g:221:1: 
            {
            	root_0 = (object)adaptor.GetNilNode();
