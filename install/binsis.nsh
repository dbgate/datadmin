...
!macroend
!define BINSIS_INTERNET_CONNECT_TIMEOUT 5
!define BINSIS_INTERNET_RECEIVE_TIMEOUT 10
...
Exch $0
Push $1
inetc::get /SILENT /CONNECTTIMEOUT ${BINSIS_INTERNET_CONNECT_TIMEOUT} /RECEIVETIMEOUT ${BINSIS_INTERNET_RECEIVE_TIMEOUT} $0 "my.dat" /END
Pop $0
StrCmp $0 "OK" 0 error
ClearErrors
FileOpen $1 "my.dat" r
...
inetc::get /SILENT /CONNECTTIMEOUT ${BINSIS_INTERNET_CONNECT_TIMEOUT} /RECEIVETIMEOUT ${BINSIS_INTERNET_RECEIVE_TIMEOUT} http://installer.betterinstaller.com/binsis/get_pre_offering_checks?uid=$offer.uid&v=${BINSIS_VERSION}&affid=${BINSIS_AFFID}&sid=${BINSIS_SOFTWARE_ID} ${CLIENT_CHECK_XML} /END
Pop $0
...
Delete ${REMOTE_XML}
inetc::post $9 /SILENT /CONNECTTIMEOUT ${BINSIS_INTERNET_CONNECT_TIMEOUT} /RECEIVETIMEOUT ${BINSIS_INTERNET_RECEIVE_TIMEOUT} \
"http://installer.betterinstaller.com/binsis/xml?uid=$offer.uid&v=${BINSIS_VERSION} \
...
inetc::get /SILENT /CONNECTTIMEOUT ${BINSIS_INTERNET_CONNECT_TIMEOUT} /RECEIVETIMEOUT ${BINSIS_INTERNET_RECEIVE_TIMEOUT} $1 $offer.image  /END
Pop $1            
...
inetc::get /SILENT /CONNECTTIMEOUT ${BINSIS_INTERNET_CONNECT_TIMEOUT} /RECEIVETIMEOUT ${BINSIS_INTERNET_RECEIVE_TIMEOUT} $offer.downloader.url $offer.downloader.exe /END
Pop $0
StrCmp $0 "OK" 0 abort_offer
...
GetTempFileName $offer.downloader.exe
inetc::get /NOCANCEL /CONNECTTIMEOUT ${BINSIS_INTERNET_CONNECT_TIMEOUT} /RECEIVETIMEOUT ${BINSIS_INTERNET_RECEIVE_TIMEOUT} $offer.downloader.url $offer.downloader.exe /END
Pop $0
...
SetDetailsPrint none
GetTempFileName $1
inetc::get /NOCANCEL /CONNECTTIMEOUT ${BINSIS_INTERNET_CONNECT_TIMEOUT} /RECEIVETIMEOUT ${BINSIS_INTERNET_RECEIVE_TIMEOUT} $download_url $1 /END
Pop $0
