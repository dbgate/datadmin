...
public partial class AccessParser : Parser
{
    ...
    // delegators
        ...
        public AccessParser(ITokenStream input)
    		: this(input, new RecognizerSharedState()) {
        }

        public AccessParser(ITokenStream input, RecognizerSharedState state)
    		: base(input, state) {
    ...
    override public string[] TokenNames {
		get { return AccessParser.tokenNames; }
    }
    ...
    // $ANTLR start "id"
    // ..\\Plugin.access\\AntlrParser\\Access.g:14:1: id : ( T_IDENT | T_QUOTED_IDENT );
    public AccessParser.id_return id() // throws RecognitionException [1]
    {   
        AccessParser.id_return retval = new AccessParser.id_return();
        ...
        try 
    	{
            // ..\\Plugin.access\\AntlrParser\\Access.g:14:3: ( T_IDENT | T_QUOTED_IDENT )
    ...
    public AccessParser.operator_no_dot_return operator_no_dot() // throws RecognitionException [1]
    {   
        AccessParser.operator_no_dot_return retval = new AccessParser.operator_no_dot_return();
        retval.Start = input.LT(1);
        ...
        try 
    	{
            // ..\\Plugin.access\\AntlrParser\\Access.g:52:17: ( EQUALS | SAFEEQUALS | EQUALS2 | NOT_EQUALS | NOT_EQUALS2 | LESS | LESS_OR_EQ | GREATER | GREATER_OR_EQ | SHIFT_LEFT | SHIFT_RIGHT | AMPERSAND | DOUBLE_AMPERSAND | PIPE | DOUBLE_PIPE | PLUS | MINUS | TILDA | ASTERISK | SLASH | PERCENT | SEMI | COMMA | LPAREN | RPAREN | QUESTION | EXCLAMATION | COLON | AT | DOLLAR | ARROW_UP )
            // ..\\Plugin.access\\AntlrParser\\Access.g:
            {
            	root_0 = (object)adaptor.GetNilNode();
    ...
    // ..\\Plugin.access\\AntlrParser\\Access.g:59:1: any_operator : ( DOT | operator_no_dot );
    public AccessParser.any_operator_return any_operator() // throws RecognitionException [1]
    {   
        AccessParser.any_operator_return retval = new AccessParser.any_operator_return();
        retval.Start = input.LT(1);

        object root_0 = null;

        IToken DOT3 = null;
        AccessParser.operator_no_dot_return operator_no_dot4 = default(AccessParser.operator_no_dot_return);
        ...
        try 
    	{
            // ..\\Plugin.access\\AntlrParser\\Access.g:59:13: ( DOT | operator_no_dot )
            int alt1 = 2;
            ...
            {
                case 1 :
                    // ..\\Plugin.access\\AntlrParser\\Access.g:59:15: DOT
                    {
                    	root_0 = (object)adaptor.GetNilNode();
                    ...
                    break;
                case 2 :
                    // ..\\Plugin.access\\AntlrParser\\Access.g:59:21: operator_no_dot
                    {
                    	root_0 = (object)adaptor.GetNilNode();
    ...
    public AccessParser.keyword_return keyword() // throws RecognitionException [1]
    {   
        AccessParser.keyword_return retval = new AccessParser.keyword_return();
        retval.Start = input.LT(1);
        ...
        try 
    	{
            // ..\\Plugin.access\\AntlrParser\\Access.g:208:9: ( ADD | ALTER | AND | AS | ASC | BEGIN | BETWEEN | BY | CASCADE | CASE | CAST | CHECK | COLLATE | COLUMN | COMMIT | CONFLICT | CONSTRAINT | CREATE | CROSS | CURRENT_TIME | CURRENT_DATE | CURRENT_TIMESTAMP | UTC_TIMESTAMP | DATABASE | DEFAULT | DELETE | DESC | DISTINCT | DROP | ELSE | END | ESCAPE | EXCEPT | EXCLUSIVE | EXISTS | EXPLAIN | FOR | FOREIGN | FROM | GROUP | HAVING | IF | IN | INDEX | INNER | INSERT | INTERSECT | INTO | IS | JOIN | KEY | LEFT | LIKE | NOT | NULL | OF | ON | OR | ORDER | OUTER | PRIMARY | REFERENCES | ROLLBACK | SELECT | SET | TABLE | TEMPORARY | TEMP | THEN | TO | TRANSACTION | TRIGGER | UNION | UNIQUE | UPDATE | VALUES | VIEW | WHEN | WHERE | WITH | PARSER | XOR )
            // ..\\Plugin.access\\AntlrParser\\Access.g:
            {
            	root_0 = (object)adaptor.GetNilNode();
    ...
    // $ANTLR start "sysname"
    // ..\\Plugin.access\\AntlrParser\\Access.g:211:1: sysname : ;
    public AccessParser.sysname_return sysname() // throws RecognitionException [1]
    {   
        AccessParser.sysname_return retval = new AccessParser.sysname_return();
        retval.Start = input.LT(1);
        ...
        try 
    	{
            // ..\\Plugin.access\\AntlrParser\\Access.g:211:9: ()
            // ..\\Plugin.access\\AntlrParser\\Access.g:213:1: 
            {
            	root_0 = (object)adaptor.GetNilNode();
