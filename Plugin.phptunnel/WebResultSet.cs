    ...
    public class WebResultSet : WebResultBase, ITunnelResultSet
    {
            ...
            : base(resp,encoding)
        {
            try
            {
                ...
                if (retcode != 0) throw new StreamFormatError("Bad retcode");
                m_affected = ReadInt4();
        ...
        public static WebResultSet CreateRequest(PtunConnection conn, string sql)
        {
            return CreateRequest(conn, sql, -1, new Dictionary<string,string>());
        }

        public static WebResultSet CreateRequest(PtunConnection conn, string sql, int limit, Dictionary<string, string> queryPars)
        {
        ...
        public object[] FetchRow()
        {
            ...
            if (!IsInBuffer4("WROW")) throw new StreamFormatError("Unexpected data");
