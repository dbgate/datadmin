...
namespace Plugin.dbmodel
{
    ...
    public class DbDiffAction
    {
        ...
        IAbstractObjectStructure m_srcObject, m_dstObject, m_anyObject;
        ...
        public IAbstractObjectStructure AnyObject
        {
            get
            {
                WantInfo();
        ...
        public IAbstractObjectStructure SourceObject
        {
            get
            {
                WantInfo();
        ...
        public IAbstractObjectStructure TargetObject
        {
            get
            {
                WantInfo();
        ...
        public string SourceConstraintName { get { return SourceColumnName; } }
        ...
        public string TargetConstraintName { get { return TargetColumnName; } }
        ...
        public string ConstraintType
        {
            ...
            {
                WantInfo();
                return Texts.Get(Constraint.GetTypeTitle(m_anyObject.GetName().ObjectType));
            }
        }
        public string SourceConstraintColumns
        {
            get
            {
                var cnt = m_srcObject as IColumnsConstraint;
        ...
        public string TargetConstraintColumns
        {
            get
            {
                var cnt = m_dstObject as IColumnsConstraint;
                if (cnt != null) return cnt.Columns.GetNames().CreateDelimitedText(",");
                return null;
            }
        }
        ...
        private void WantInfo()
        {
            ...
            if (m_repr != null) m_typeImage = m_repr.Icon;
            if (m_typeImage == null && name != null) m_typeImage = Constraint.GetTypeBitmap(name.ObjectType);
            if (m_typeImage == null && m_anyObject is IColumnStructure) m_typeImage = CoreIcons.column;
        }
        ...
        public string GenerateSql(IDatabaseSource targetDb)
        {
            var plan = GetPlanForThis(targetDb, true);
            return m_diff.m_dialect.GenerateScript(dmp => plan.CreateRunner().Run(dmp, m_diff.m_options));
        }
        ...
        protected void SetMappings(params IAbstractObjectStructure[] objs)
        {
