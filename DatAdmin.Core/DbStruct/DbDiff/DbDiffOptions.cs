...
namespace DatAdmin
{
    public class DbDiffOptions
    {
        ...
        public ILogger DiffLogger = NopLogger.Instance;
        public ILogger AlterLogger = NopLogger.Instance;
        ...
        internal void SetLogger(DbDiffOptsLogger ltype, ILogger logger)
        {
