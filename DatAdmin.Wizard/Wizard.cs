...
//			}
		...
		protected internal void ActivatePage(WizardPage page)
		{
			...
			{
                btnNext.Text = TranslateText("s_wiz_next");
			...
			{
                btnNext.Text = TranslateText("s_wiz_finish");
        ...
        {
            TranslateTextEventArgs args = new TranslateTextEventArgs { OriginalText = value };
            if (OnTranslate != null) OnTranslate(this, args);
            return args.TranslatedText ?? args.OriginalText;
        }

        public event TranslateEventHandler OnTranslate;
    ...
    public class TranslateTextEventArgs : EventArgs
    {
        public string OriginalText;
        public string TranslatedText;
    }

    public delegate void TranslateEventHandler(object sender, TranslateTextEventArgs e);
}