...
public partial class EffiProzParser : Parser
{
    ...
    // delegators
        ...
        public EffiProzParser(ITokenStream input)
    		: this(input, new RecognizerSharedState()) {
        }

        public EffiProzParser(ITokenStream input, RecognizerSharedState state)
    		: base(input, state) {
    ...
    override public string[] TokenNames {
		get { return EffiProzParser.tokenNames; }
    }
    ...
    public EffiProzParser.operator_no_dot_return operator_no_dot() // throws RecognitionException [1]
    {   
        EffiProzParser.operator_no_dot_return retval = new EffiProzParser.operator_no_dot_return();
        retval.Start = input.LT(1);
    ...
    // ..\\Plugin.EffiProz\\AntlrParser\\EffiProz.g:59:1: any_operator : ( DOT | operator_no_dot );
    public EffiProzParser.any_operator_return any_operator() // throws RecognitionException [1]
    {   
        EffiProzParser.any_operator_return retval = new EffiProzParser.any_operator_return();
        retval.Start = input.LT(1);

        object root_0 = null;

        IToken DOT3 = null;
        EffiProzParser.operator_no_dot_return operator_no_dot4 = default(EffiProzParser.operator_no_dot_return);
        ...
        try 
    	{
            // ..\\Plugin.EffiProz\\AntlrParser\\EffiProz.g:59:13: ( DOT | operator_no_dot )
            int alt1 = 2;
            ...
            {
                case 1 :
                    // ..\\Plugin.EffiProz\\AntlrParser\\EffiProz.g:59:15: DOT
                    {
                    	root_0 = (object)adaptor.GetNilNode();
                    ...
                    break;
                case 2 :
                    // ..\\Plugin.EffiProz\\AntlrParser\\EffiProz.g:59:21: operator_no_dot
                    {
                    	root_0 = (object)adaptor.GetNilNode();
    ...
    public EffiProzParser.keyword_return keyword() // throws RecognitionException [1]
    {   
        EffiProzParser.keyword_return retval = new EffiProzParser.keyword_return();
        retval.Start = input.LT(1);
    ...
    // $ANTLR start "sysname"
    // ..\\Plugin.EffiProz\\AntlrParser\\EffiProz.g:211:1: sysname : ;
    public EffiProzParser.sysname_return sysname() // throws RecognitionException [1]
    {   
        EffiProzParser.sysname_return retval = new EffiProzParser.sysname_return();
        retval.Start = input.LT(1);
        ...
        try 
    	{
            // ..\\Plugin.EffiProz\\AntlrParser\\EffiProz.g:211:9: ()
            // ..\\Plugin.EffiProz\\AntlrParser\\EffiProz.g:213:1: 
            {
            	root_0 = (object)adaptor.GetNilNode();
